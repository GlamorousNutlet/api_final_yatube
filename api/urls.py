...
comment_router.register(r'api/v1/posts/(?P<post_id>\d+)/comments', CommentViewSet, basename='comment')
...
urlpatterns = post_router.urls + comment_router.urls + follow_router.urls + group_router.urls
